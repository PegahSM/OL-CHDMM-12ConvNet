...
%for ii = 1:231 % or your number of files
 %imwrite(c{1,ii},"/AHdmmsMSRAction/filename" + c{2,ii} + ".mat") % where a is your cell array of images
%end
%imageDatstore('AHdmmsMSRAction/','IncludeSubfolders',true,'LabelSource','foldernames');
%imds = imageDatastore(c{1,:});
